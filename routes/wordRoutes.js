 ...
 */
router.post('/', [authMiddleware.verifyToken, authMiddleware.isAdmin], wordController.addWord);
 ...
 *         description: Some server error
 */
router.put('/:id', [authMiddleware.verifyToken, authMiddleware.isAdmin], wordController.updateWord);
 ...
 *         description: Some server error
 */
router.delete('/:id', [authMiddleware.verifyToken, authMiddleware.isAdmin], wordController.deleteWord);
